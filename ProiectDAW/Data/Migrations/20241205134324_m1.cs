    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowRequests", x => new { x.FollowerId, x.FollowedId });
                    table.ForeignKey(
                        name: "FK_FollowRequests_AspNetUsers_FollowedId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratigs", x => new { x.UserId, x.LocationId });
                    table.ForeignKey(
                        name: "FK_Ratigs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratigs_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostLocations", x => new { x.PostId, x.LocationId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowRequests_FollowedId",
